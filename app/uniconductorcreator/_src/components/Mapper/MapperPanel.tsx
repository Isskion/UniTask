...
const MAPPING_MEMORY_KEY = 'ucc_mapping_memory';

// No hay pestaña "Dinámicos": esta herramienta no usa CampoDinamico (ver nota de diseño en
// schema.ts). Transportes/Operaciones son pestañas normales con slots numerados fijos
// (Root.Conductor.transportes[1..MAX_TRANSPORTES], operaciones[1..MAX_OPERACIONES]).
const TABS = [
    { id: 'pConductor', label: '👤 Conductor', group: 'ENT' },
    { id: 'Transportes', label: '🚚 Transportes', group: 'OP' },
