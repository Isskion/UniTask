        ...
        <header className="flex h-[54px] items-center px-4 justify-between shrink-0 sticky top-0 z-50 bg-gradient-to-r from-[#0f172a] via-[#1e1b4b] to-[#0f172a] border-b border-white/[0.06] shadow-[0_1px_3px_rgba(0,0,0,0.4),0_4px_12px_rgba(0,0,0,0.15)]">
            <div className="flex items-center gap-3 pr-5 border-r border-white/[0.08] h-full">
                ...
                <div className="flex flex-col leading-tight">
                    <span className="text-[13px] font-extrabold text-white tracking-[-0.02em]">Conductor Creator</span>
            ...
            <div className="flex items-center gap-2">
                ...
                <div className="flex items-center gap-1.5 bg-slate-800/40 p-1 rounded-xl border border-white/[0.05]">
                    ...
                    <div className="flex items-center gap-1">
                        ...
                        <button className={`${btnBase} bg-amber-500/15 text-amber-300 border border-amber-400/25 hover:bg-amber-500/25`} onClick={onSendRemainingUnique} disabled={!hasData || !token} title="Envía solo las filas no importadas todavía, sin duplicar NroDocumento ya existentes">
                            <span className="text-xs">📦</span>
                            <span className="hidden xl:inline">Resto (Documento único)</span>
                        </button>
                        {failedCount > 0 && (
