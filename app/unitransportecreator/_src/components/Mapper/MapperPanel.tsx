...
const MAPPING_MEMORY_KEY = 'utrc_mapping_memory';

const TABS = [
    { id: 'pTransporte', label: '🚚 Transporte', group: 'ENT' },
    { id: 'Tendering', label: '📡 Tendering', group: 'TEN' },
    { id: 'Conductores', label: '🪪 Conductores', group: 'COND' },
];
