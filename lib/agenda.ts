...
export async function updateConsultant(id: string, data: Partial<Pick<AgendaConsultant, 'name' | 'sortOrder' | 'region' | 'regions' | 'isActive' | 'divisions' | 'aliases'>>): Promise<void> {
