...
-- Incluye los 5 estados de programación de Pedido, estados espejo, Viaje Finalizado, Parada Recolectado Parcial y Estados de Visita.
...
-- ---------------------------------------------------------
IF EXISTS (SELECT 1 FROM dbo.EstadoParadaVisita WHERE IdEstadoParadaVisita = 0)
BEGIN
    UPDATE dbo.EstadoParadaVisita
    SET Descripcion = 'PENDIENTE', Color = 13421772
    WHERE IdEstadoParadaVisita = 0
END
ELSE
BEGIN
    SET IDENTITY_INSERT dbo.EstadoParadaVisita ON;
    INSERT INTO dbo.EstadoParadaVisita (IdEstadoParadaVisita, Descripcion, Color)
    VALUES (0, 'PENDIENTE', 13421772);
    SET IDENTITY_INSERT dbo.EstadoParadaVisita OFF;
END
GO

IF EXISTS (SELECT 1 FROM dbo.EstadoParadaVisita WHERE IdEstadoParadaVisita = 1)
BEGIN
    UPDATE dbo.EstadoParadaVisita
    SET Descripcion = 'VISITANDO', Color = 13421772
    WHERE IdEstadoParadaVisita = 1
END
ELSE
BEGIN
    SET IDENTITY_INSERT dbo.EstadoParadaVisita ON;
    INSERT INTO dbo.EstadoParadaVisita (IdEstadoParadaVisita, Descripcion, Color)
    VALUES (1, 'VISITANDO', 13421772);
    SET IDENTITY_INSERT dbo.EstadoParadaVisita OFF;
END
GO

IF EXISTS (SELECT 1 FROM dbo.EstadoParadaVisita WHERE IdEstadoParadaVisita = 2)
BEGIN
    UPDATE dbo.EstadoParadaVisita
    SET Descripcion = 'VISITADO', Color = 16239131
    WHERE IdEstadoParadaVisita = 2
END
ELSE
BEGIN
    SET IDENTITY_INSERT dbo.EstadoParadaVisita ON;
    INSERT INTO dbo.EstadoParadaVisita (IdEstadoParadaVisita, Descripcion, Color)
    VALUES (2, 'VISITADO', 16239131);
    SET IDENTITY_INSERT dbo.EstadoParadaVisita OFF;
END
GO

IF EXISTS (SELECT 1 FROM dbo.EstadoParadaVisita WHERE IdEstadoParadaVisita = 3)
BEGIN
    UPDATE dbo.EstadoParadaVisita
    SET Descripcion = 'VISITADO FUERA DE HORARIO', Color = 4635634
    WHERE IdEstadoParadaVisita = 3
END
ELSE
BEGIN
    SET IDENTITY_INSERT dbo.EstadoParadaVisita ON;
    INSERT INTO dbo.EstadoParadaVisita (IdEstadoParadaVisita, Descripcion, Color)
    VALUES (3, 'VISITADO FUERA DE HORARIO', 4635634);
    SET IDENTITY_INSERT dbo.EstadoParadaVisita OFF;
END
GO

IF EXISTS (SELECT 1 FROM dbo.EstadoParadaVisita WHERE IdEstadoParadaVisita = 4)
BEGIN
    UPDATE dbo.EstadoParadaVisita
    SET Descripcion = 'VISITADO FUERA DE ORDEN', Color = 12876773
    WHERE IdEstadoParadaVisita = 4
END
ELSE
BEGIN
    SET IDENTITY_INSERT dbo.EstadoParadaVisita ON;
    INSERT INTO dbo.EstadoParadaVisita (IdEstadoParadaVisita, Descripcion, Color)
    VALUES (4, 'VISITADO FUERA DE ORDEN', 12876773);
    SET IDENTITY_INSERT dbo.EstadoParadaVisita OFF;
END
GO
