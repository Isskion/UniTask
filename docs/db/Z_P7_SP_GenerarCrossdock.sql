...
-- =============================================================================
-- SQL Script: [P7] Generador Operativo de Viajes/Órdenes Crossdock (HESA)
-- AUTOR:           Antigravity
-- FECHA:           18/05/2026
-- VERSIÓN:         v5.0 (Optimizado para HESA)
...
CREATE OR ALTER PROCEDURE [dbo].[Z_P7_SP_GenerarCrossdock]
    @IdPedido  INT,
