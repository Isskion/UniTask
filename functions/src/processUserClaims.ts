...
// ------------------------------------------------------------------
export const processUserClaims = functions.region('europe-west1').auth.user().onCreate(async (user) => {
 ...
 */
export const updateUserClaims = functions.region('europe-west1').https.onCall(async (data, context) => {
