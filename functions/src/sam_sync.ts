 ...
 */
export const syncResourceScope = functions.firestore
    ...
    .onWrite(async (change, context) => {
        ...
        if (collection !== 'projects' && collection !== 'tasks') return null;
        ...
        if (!data.regionId || !data.divisionId) return null;
        ...
        return change.after.ref.update({
            ...
            tenantId: tenantId, // Enforce tenantId match with path
